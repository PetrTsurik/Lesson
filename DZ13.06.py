...
while True:
    ...
    if answer == "YES":
        ...
        print("=" * 40, "\nSTEP №4")
        print("Выберите время на партию для настольной игры: \n-time1- 10 минут; \n-time2- 20 минут; \n-time3- 60 минут; \n-time4- 2 часа.")
        STEP4 = input("Введите время ан партию настольной игры: ")
        if STEP4 == time1 or STEP4 == time2 or STEP4 == time3 or STEP4 == time4:
            order = order + "-Время: " + STEP4 + "\n"
        else:
            order = order + "-Время: " + STEP4 + "(Информация введена не корректно!)" + "\n"
        print("=" * 40, "\nSTEP №5")
        print("Выберите минимальный возраст для настольной игры: \n-age1-5 лет; \n-age2-10 лет; \n-age3-16 лет; \n-age4-Для взрослых.")
        STEP5 = input("Введите минимальный возраст настольной игры: ")
        if STEP5 == age1 or STEP5 == age2 or STEP5 == age3 or STEP5 == age4:
            order = order + "-Минимальный возраст: " + STEP5 + "\n"
        else:
            order = order + "-Минимальный возраст: " + STEP5 + "(Информация введена не корректно!)" + "\n"
        print("=" * 40, "\nSTEP №6")
